...
class WarningPresenter: BasePresenter{
    var process = 0
    var status = ""
    ...
    func getWarning(Longitude: Double, Latitude: Double){
        status = "GetWarning"
        let urlsession = UrlSession(url: ServerContentURL.warning ,delegate:self)
